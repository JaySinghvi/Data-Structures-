...
void display(node *head){
                ...
                node *temp=head;
                while(temp!=NULL)//remember here its temp only and not temp->next
                    {
                        printf("%d\t",temp->data);
                        temp=temp->next;
                    }//remember no return head in this and also not other printf to print the last element
